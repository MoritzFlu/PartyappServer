...
class TinyDB_Interface(DBInterface):
    ...
    def __init__(self):
        ...
        self.SearchDB = TinyDB('DB/search.json')
    ...
    def insert_song(self, ID, Title, Interpreter, Path):
        self.SongsDB.insert(
            {
                'ID':ID,
                'Title':Title,
    ...
    def insert_playlist(self, ID, Title, Interpreter, Points):
        self.PlaylistDB.insert(
            {
                'ID':ID,
                'Titel':Titel,
                'Interpret':Interpret,
